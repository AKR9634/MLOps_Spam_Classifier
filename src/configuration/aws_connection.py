...
class S3Client:
    ...
    def __init__(self, region_name = REGION_NAME):
        ...
        if self.s3_resource is None or self.s3_client is None:
            ...
            self.s3_resource = boto3.resource('s3', __access_key_id, __secret_access_key, region_name)
            self.s3_client = boto3.client('s3', __access_key_id, __secret_access_key, region_name)
